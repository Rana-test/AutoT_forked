...
def calculate_breakevens(df):
        ...
        lower_be = df[(df['ord_type']=="P")&(df['buy_sell']=="S")]['tsym'][13:].astype(int).iloc(0)-net_credit
        higher_be = df[(df['ord_type']=="P")&(df['buy_sell']=="S")]['tsym'][13:].astype(int).iloc(0)+net_credit
