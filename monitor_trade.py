...
def calculate_breakevens(df):
        ...
        lower_be = df[(df['ord_type']=="P")&(df['buy_sell']=="S")]['tsym'][13:].index(0).astype(int)-net_credit
        higher_be = df[(df['ord_type']=="P")&(df['buy_sell']=="S")]['tsym'][13:].index(0).astype(int)+net_credit
